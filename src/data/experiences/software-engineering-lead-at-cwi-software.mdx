...
- Promoted the company's culture by delivering tech talks about **software development best practices**;
- Improved the frontend applications' **performance** by using **caching** and **lazy loading** strategies.
